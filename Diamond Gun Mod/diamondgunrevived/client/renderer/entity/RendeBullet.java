...
public class RendeBullet extends Render
{
    ...
    public void renderArrow(EntityBullet par1EntityBullet, double par2, double par4, double par6, float par8, float par9)
    {
        ...
        float f11 = (float)par1EntityBullet.arrowShake - par9;
    ...
    protected ResourceLocation getArrowTextures(EntityBullet par1EntityBullet)
    {
