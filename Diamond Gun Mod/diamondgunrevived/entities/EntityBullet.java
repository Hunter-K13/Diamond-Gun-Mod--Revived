...
public class EntityBullet extends Entity implements IProjectile
{
    ...
    public EntityBullet(World par1World, EntityLivingBase par2EntityLivingBase, float par3)
    {
        ...
        this.yOffset = 0.0F;
        this.motionX = (double)((-MathHelper.sin(this.rotationYaw / 180.0F * (float)Math.PI) * MathHelper.cos(this.rotationPitch / 180.0F * (float)Math.PI)) * 100);
        this.motionZ = (double)((MathHelper.cos(this.rotationYaw / 180.0F * (float)Math.PI) * MathHelper.cos(this.rotationPitch / 180.0F * (float)Math.PI)) * 100);
        this.motionY = (double)((-MathHelper.sin(this.rotationPitch / 180.0F * (float)Math.PI)) * 100);
        ...
        else
        {
            ...
            if (movingobjectposition != null)
            {
                ...
                else
                {
                    ...
                    this.playSound("random.bowhit", 1.0F, 1.2F / (this.rand.nextFloat() * 0.2F + 0.9F));
                	System.out.println("Client: " + worldObj.isRemote + ", BulletType: " + getBulletType());
                    this.setDead();
                    /*this.arrowShake = 7;
    ...
    public void readEntityFromNBT(NBTTagCompound nbt)
    {
        ...
        this.type = getTypeFromString(nbt.getString("type"));
    }
    ...
    public BulletType getTypeFromString(String name) {
    	if (name.equals("SHOTGUNSHELL")) {
    		return BulletType.SHOTGUNSHELL;
    	}else if (name.equals("ASSAULTSHELL")) {
    		return BulletType.ASSAULTSHELL;
    	}else if (name.equals("FIFTYCALIBER")) {
    		return BulletType.FIFTYCALIBER;
    	}else {
    		return null;
    	}
    }
