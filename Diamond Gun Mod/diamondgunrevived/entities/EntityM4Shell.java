...
public class EntityM4Shell extends Entity implements EntityShot {
	private int xTile;
	private int yTile;
	private int zTile;
	private int inTile;
	...
	public EntityM4Shell(World world, EntityPlayer entityplayer) {
		super(world);
		this.xTile = -1;
		this.yTile = -1;
		this.zTile = -1;
	...
	public EntityM4Shell(World world, double d, double d1, double d2) {
		super(world);
		this.xTile = -1;
		this.yTile = -1;
		this.zTile = -1;
	...
	public EntityM4Shell(World world, EntityLivingBase entityliving, float f) {
		super(world);
		this.xTile = -1;
		this.yTile = -1;
		this.zTile = -1;
	...
	public void setArrowHeading(double d0, double d1, double d2, float f, float f1) {
