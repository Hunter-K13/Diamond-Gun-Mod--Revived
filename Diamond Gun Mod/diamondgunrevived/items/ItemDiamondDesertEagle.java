...
public class ItemDiamondDesertEagle extends Item implements IGun {
	
	public static final String[] bowPullIconNameArray = new String[] {"pulling_0", "pulling_1", "pulling_2"};
    @SideOnly(Side.CLIENT)
    private Icon[] iconArray;
	
	public ItemDiamondDesertEagle(int par1) {
	super(par1);
	setCreativeTab(DiamondGunRevived.gunTab);
	setMaxStackSize(1);
    setMaxDamage(384);
	setUnlocalizedName(ItemInfo.EagleUnlocal);
	}
	...
	public void onPlayerStoppedUsing(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer, int par4)
	{
	    ...
	    if (flag || par3EntityPlayer.inventory.hasItem(Item.arrow.itemID))
	    {
	        ...
	        entityarrow.setBulletType(BulletType.FIFTYCALIBER);
	...
	public void registerIcons(IconRegister register) {
		itemIcon = register.registerIcon(ItemInfo.TEXTURE_LOCATION + ":" + ItemInfo.EagleIcon);
	}
